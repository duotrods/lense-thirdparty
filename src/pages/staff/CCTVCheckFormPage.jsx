    ...
    try {
      ...
      if (form) {
        setFormData({
          ...
          date: form.date || "",
          time: form.time || "",
          a66Cameras: form.a66Cameras || [],
          a66Comments: form.a66Comments || "",
          a66Blackspot: Array.isArray(form.a66Blackspot) ? form.a66Blackspot.length > 0 : (form.a66Blackspot || false),
          a66TssInformed: form.a66TssInformed || false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const trimmedData = {
        ...
        a66Comments: formData.a66Comments.trim(),
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          {isDemo ? (
            ...
            <>
              {renderCheckboxSection(
                "A66-WJ (only tick cameras that are not working correctly)",
                "a66Cameras",
                "a66Comments",
                cameraOptions.a66,
                "a66Blackspot",
